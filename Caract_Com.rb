...
def caracteres_comuns(strings, ordem = :alfabetica)
  ...
  resultado_alfabetica = caracteres_comuns(strings, :alfabetica)
  resultado_lexicografica = caracteres_comuns(strings, :lexicografica)
  
  # Exibe os resultados
  puts "Ordem Alfabética: #{resultado_alfabetica}"
  puts "Ordem Lexicográfica: #{resultado_lexicografica}"
